...
## 📺 عن اللعبة
لعبة **"بيننا دخيل"** هي لعبة جماعية (Local Party Game) تُلعب على جهاز هاتف واحد يتم تمريره بين اللاعبين. تعتمد اللعبة على طرح أسئلة سرية ومموهة من فئة معينة، حيث يحصل اللاعبون العاديون على سؤال، بينما يحصل "الدخيل" على سؤال مختلف تماماً! بعد ذلك تبدأ مرحلة النقاش والإجابات الذكية، وينتهي الدور بالتصويت السري لمعرفة الدخيل.

### ✨ المميزات التقنية:
* **تطبيق ويب تقدمي (PWA):** يمكن تثبيت اللعبة على الهواتف الذكية (Android & iOS) وتشغيلها بدون إنترنت بالكامل عبر الـ Service Worker.
...
2. **تمرير الهاتف:** يظهر اسم اللاعب على الشاشة، يأخذ الهاتف ويضغط للكشف عن سؤاله السري، ثم يمرره للاعب التالي.
3. **النقاش والتمويه:** بعد معرفة الجميع بأسئلتهم، يقوم كل لاعب بذكر إجابته بصوت عالٍ بشرط ألا يكشف سؤاله.
...
* **الفكرة والتصميم:** فريق الرنجالة (El-Rengala Team).
